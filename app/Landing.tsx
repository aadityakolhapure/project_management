...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-background/95 dotted-bg">
      {/* Hero Section */}
        ...
        <div className="max-w-[800px] mx-auto text-center space-y-8 mb-20">
          <div className="space-y-6">
            ...
            <p className="text-xl text-muted-foreground max-w-[600px] mx-auto">
              Streamline Your Workflow with <span className="text-purple-500">BRAINWAVE</span>
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            {user ? (
              ...
              <>
                ...
                <Button size="lg" variant="outline" className="border-purple-500 text-purple-500" asChild>
